...
> **age: list[str]** - [age list](https://github.com/ClanGenOfficial/clangen/wiki/%5BWriting%5D-%E2%80%90-Basic#ages)  (yes, Outsider kittens could be chosen for these interactions)
